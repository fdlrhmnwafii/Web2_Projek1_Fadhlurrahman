  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index.php" class="nav-link">Praktikum 1</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="praktikum2.php" class="nav-link active">Praktikum 2</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">Praktikum 2</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-8">
                  ...
                  if (!empty($proses)) {
                    ...
                    if ($jumlah >= 0 && $produk == "Televisi") {
                      ...
                      echo '<p class="text-md-start">Total Belanja : Rp. ' . number_format($total, 2, ',', '.') . '</p>';
